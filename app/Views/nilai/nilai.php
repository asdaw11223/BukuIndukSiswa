                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <input type="hidden" class="form-control"
                                            name="id_matapelajaran<?= $n['id_nilai']?>" value="<?= $n['id_matapelajaran'] ?>">
                                            <input type="hidden" class="form-control"
                                            name="s_NISN<?= $n['id_nilai']?>" value="<?= $n['s_NISN'] ?>">
                                            <input type="hidden" class="form-control"
                                            name="id_kelas" value="<?= $n['id_kelas'] ?>">

                                            <input onClick="this.select();" type="text" class="form-control" id="np_kb<?= $n['id_nilai']?>" 
                                            name="np_kb<?= $n['id_nilai']?>" value="<?= $n['np_kb'] ?>">
                                        </td>
                                        <td>
